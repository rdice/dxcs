...
App({
  onLaunch: function () {
    ...
    let options = {
      SDKAppID: 1400315046 // 接入时需要将0替换为您的即时通信 IM 应用的 SDKAppID
    };
  ...
  memberId:"",//服务用户id
  accout:"",//聊天用户id
  // root: 'http://192.168.2.154:8081/',
  // rootquery: 'http://192.168.2.154:8081/znfw/',//查询
  // roothd: 'http://192.168.2.154:8081/fzx/controller/',//提交
